...
const Texts = (): JSX.Element => {
    ...
    return (
        <>
            <mesh position={[-3.6, 0, -10]} ref={el => texts.current[0] = el}>
                <textGeometry args={['GIMNAZJUM W RZEZAWIE', headerOptions]} />
                <meshStandardMaterial color={'#ff4d17'} />
            </mesh>
            <mesh position={[-4.2, -0.4, -10]} ref={el => texts.current[1] = el}>
            ...
            <mesh position={[-0.7, 0, -10]} ref={el => texts.current[2] = el}>
                <textGeometry args={['TECHNIKUM ŁĄCZNOŚCI\nNR 14 W KRAKOWIE', headerOptions]} />
                <meshStandardMaterial color={'#ff4d17'} />
            </mesh>
            <mesh position={[-1, -0.8, -10]} ref={el => texts.current[3] = el}>
            ...
            <mesh position={[2.2, 0, -10]} ref={el => texts.current[4] = el}>
                <textGeometry args={['POLITECHNIKA\nKRAKOWSKA', headerOptions]} />
                <meshStandardMaterial color={'#ff4d17'} />
            </mesh>
            <mesh position={[2.4, -0.8, -10]} ref={el => texts.current[5] = el}>
...
const Objects = (): JSX.Element => {
    ...
    return (
        <>
            <mesh position={[-3, 1, -10]} scale={[0.1, 0.1, 0.1]}>
                <primitive object={school} />
            </mesh>
            <mesh position={[0, 1, -10]} scale={[0.2, 0.2, 0.2]}>
                <primitive object={college} />
            </mesh>
            <mesh position={[3, 1, -10]} scale={[0.2, 0.2, 0.2]}>
